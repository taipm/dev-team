...
output_locations:
  user_outputs: "docs/pm/"
  subdirs:
    - logs/              # Session transcripts
    - user-stories/      # User story documents
    - tech-specs/        # Technical specifications
    - estimations/       # Estimation reports

# Agent internals (optional git)
agent_memory: ".microai/agents/microai/teams/pm-dev/memory/"
...
├── user-stories/
│   └── 2024-01-15-notification-feature-stories.md
├── tech-specs/
│   └── payment-gateway-spec.md
└── estimations/
    └── 2024-01-15-dashboard-redesign-estimate.md
```
