...
2. Save output document to docs/pm/logs/
...
```
docs/pm/logs/{YYYY-MM-DD}-{mode}-{topic-slug}.md

Examples:
- docs/pm/logs/2024-01-15-requirements-user-notifications.md
- docs/pm/logs/2024-01-15-tech-spec-payment-gateway.md
- docs/pm/logs/2024-01-15-estimation-dashboard-redesign.md
```
...
Output saved to: `docs/pm/logs/{filename}.md`
