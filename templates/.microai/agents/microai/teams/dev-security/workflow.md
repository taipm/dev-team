...
agent_memory: ".microai/agents/microai/teams/dev-security/memory/"
...
├── audits/
│   └── 2024-01-15-user-portal-audit.md
├── threat-models/
│   └── auth-system-threat-model.md
└── reviews/
    └── 2024-01-15-payment-api-review.md
```
