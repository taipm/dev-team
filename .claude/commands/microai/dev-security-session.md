...
2. Save to `.microai/docs/teams/dev-security/logs/{date}-{mode}-{topic-slug}.md`
...
- Review: `.microai/docs/teams/dev-security/logs/{YYYY-MM-DD}-review-{slug}.md`
- Threat Model: `.microai/docs/teams/dev-security/logs/{YYYY-MM-DD}-threat-model-{slug}.md`
- Vulnerability: `.microai/docs/teams/dev-security/logs/{YYYY-MM-DD}-vulnerability-{slug}.md`
