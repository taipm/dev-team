...
2. Save to `.microai/docs/teams/dev-architect/logs/{date}-{mode}-{topic-slug}.md`
...
- Design: `.microai/docs/teams/dev-architect/logs/{YYYY-MM-DD}-design-{slug}.md`
- Review: `.microai/docs/teams/dev-architect/logs/{YYYY-MM-DD}-review-{slug}.md`
- ADR: `.microai/docs/teams/dev-architect/logs/{YYYY-MM-DD}-adr-{slug}.md`
