...
2. Save to `.microai/docs/teams/pm-dev/logs/{date}-{mode}-{topic-slug}.md`
...
- Requirements: `.microai/docs/teams/pm-dev/logs/{YYYY-MM-DD}-requirements-{slug}.md`
- Tech Spec: `.microai/docs/teams/pm-dev/logs/{YYYY-MM-DD}-tech-spec-{slug}.md`
- Estimation: `.microai/docs/teams/pm-dev/logs/{YYYY-MM-DD}-estimation-{slug}.md`
