...
2. Save report to .microai/docs/teams/dev-security/logs/
...
║                                                                 ║
║  Output saved to:                                               ║
║    .microai/docs/teams/dev-security/logs/{filename}.md         ║
║                                                                 ║
║  Sign-off:                                                      ║
...
```
.microai/docs/teams/dev-security/logs/{YYYY-MM-DD}-{mode}-{topic-slug}.md

Examples:
- .microai/docs/teams/dev-security/logs/2024-01-15-review-payment-api.md
- .microai/docs/teams/dev-security/logs/2024-01-15-threat-model-auth-system.md
- .microai/docs/teams/dev-security/logs/2024-01-15-vulnerability-user-portal.md
```
...
Report saved to: `.microai/docs/teams/dev-security/logs/{filename}.md`
