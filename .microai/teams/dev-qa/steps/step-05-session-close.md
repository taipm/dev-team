...
2. Save output document to .microai/docs/teams/dev-qa/logs/
...
```
.microai/docs/teams/dev-qa/logs/{YYYY-MM-DD}-{mode}-{topic-slug}.md

Examples:
- .microai/docs/teams/dev-qa/logs/2024-01-15-testplan-user-authentication.md
- .microai/docs/teams/dev-qa/logs/2024-01-15-bug-login-safari-500-error.md
- .microai/docs/teams/dev-qa/logs/2024-01-15-review-pr-123-payment-refactor.md
```
...
- session_id: "{session_id}"
  ...
  outcome: "{summary}"
  artifacts:
    - ".microai/docs/teams/dev-qa/logs/{filename}.md"
  key_decisions:
    - "{decision_1}"
    - "{decision_2}"
```
...
Output saved to: `.microai/docs/teams/dev-qa/logs/{filename}.md`
