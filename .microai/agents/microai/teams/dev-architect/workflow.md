...
│    ├── Save to .microai/docs/teams/dev-architect/logs/          │
│    ├── Update team memory                                       │
│    └── Display summary                                          │
│                                                                  │
└─────────────────────────────────────────────────────────────────┘
...
```
.microai/docs/teams/dev-architect/logs/
├── 2024-01-15-design-order-processing.md
├── 2024-01-15-review-payment-service.md
└── 2024-01-15-adr-database-selection.md
```
