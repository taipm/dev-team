...
2. Save output document to .microai/docs/teams/dev-architect/logs/
...
║    • Saved to: .microai/docs/teams/dev-architect/logs/{file}   ║
║                                                                 ║
║  Key Decisions:                                                 ║
║    1. {decision_1}                                             ║
║    2. {decision_2}                                             ║
...
```
.microai/docs/teams/dev-architect/logs/{YYYY-MM-DD}-{mode}-{topic-slug}.md

Examples:
- .microai/docs/teams/dev-architect/logs/2024-01-15-design-order-processing.md
- .microai/docs/teams/dev-architect/logs/2024-01-15-review-payment-service.md
- .microai/docs/teams/dev-architect/logs/2024-01-15-adr-database-selection.md
```
...
- session_id: "{session_id}"
  ...
  outcome: "{summary}"
  artifacts:
    - ".microai/docs/teams/dev-architect/logs/{filename}.md"
  key_decisions:
    - "{decision_1}"
    - "{decision_2}"
  patterns_applied:
...
Output saved to: `.microai/docs/teams/dev-architect/logs/{filename}.md`
